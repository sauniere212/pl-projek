...
<head>
    ...
    <title>SP4N Lapor - DISPERUMKIM Kota Bogor</title>
</head>
<body>
    <!-- Navbar -->
            ...
            <div class="col-12 mb-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-primary text-white py-2 px-3">
                        ...
                        <li class="breadcrumb-item active text-white" aria-current="page">SP4N LAPOR</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">PENGADUAN SP4N LAPOR</h5>
                    </div>
                    <div class="card-body">
                        <h4>Pengaduan SP4N Lapor</h4>
                        <p>Sistem Pengelolaan Pengaduan Pelayanan Publik Nasional (SP4N) – Layanan Aspirasi dan Pengaduan Online Rakyat (LAPOR) atau dikenal dengan SP4N-LAPOR adalah Aplikasi Sistem Pengelolaan Pengaduan Pelayanan Publik Nasional menggunakan aplikasi LAPOR!</p>
                        
                        <p class="mt-4">Sampaikan pengaduan atau saran mengenai semua pelayanan publik melalui link berikut :</p>
                        
                        <div class="mt-4 text-center">
                            <div class="mb-4">
                                <div style="background-color: #dc3545; color: white; padding: 20px; border-radius: 10px; display: inline-block; margin-bottom: 20px;">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card h-100">
                                        <div class="card-body text-center">
                                            ...
                                            <a href="https://play.google.com/store/apps/details?id=com.deptech.lapor&hl=in&gl=US" 
                                               target="_blank" 
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card h-100">
                                        <div class="card-body text-center">
                                            ...
                                            <a href="https://apps.apple.com/id/app/sp4n-lapor/id1486554343" 
                                               target="_blank" 
