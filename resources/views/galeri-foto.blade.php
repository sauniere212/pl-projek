...
<head>
    ...
    <title>Galeri Foto - DISPERUMKIM Kota Bogor</title>
</head>
<body>
    <!-- Navbar -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="text-center mb-4">Galeri Foto DISPERUMKIM Kota Bogor</h2>
            </div>
        </div>
                ...
                @foreach($galeriFotos as $galeri)
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            @if($galeri->foto)
                                <img src="{{ asset('storage/' . $galeri->foto) }}" class="card-img-top" alt="{{ $galeri->judul_album }}" style="height: 250px; object-fit: cover;">
                            @else
                            ...
                            @endif
                            <div class="card-body">
                                <h5 class="card-title">{{ $galeri->judul_album }}</h5>
                                <p class="card-text">{{ $galeri->deskripsi }}</p>
                                <small class="text-muted">
                                    <i class="fas fa-calendar"></i> {{ \Carbon\Carbon::parse($galeri->tanggal)->format('d M Y') }}
                                </small>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> Belum ada galeri foto yang tersedia.
                    </div>
                </div>
            </div>
        @endif
