...
<head>
    ...
    <title>Berita - DISPERUMKIM Kota Bogor</title>
</head>
<body>
    <!-- Navbar -->
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <small class="text-muted">
                                        <i class="fas fa-calendar"></i> {{ \Carbon\Carbon::parse($berita->tanggal)->format('d M Y') }}
                                        <br>
                                        <i class="fas fa-tag"></i> {{ $berita->kategori }}
                                    </small>
                                </p>
                                <p class="card-text">{{ Str::limit($berita->isi, 150) }}</p>
                                <a href="{{ route('berita.show', $berita->id) }}" class="btn btn-primary btn-sm">
                                    Baca Selengkapnya
                                </a>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> Belum ada berita yang tersedia.
                    </div>
                </div>
            </div>
        @endif
