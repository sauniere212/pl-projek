...
<head>
    ...
    <title>Visi dan Misi - DISPERUMKIM Kota Bogor</title>
</head>
<body>
    <!-- Navbar -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="text-center mb-4">Visi dan Misi DISPERUMKIM Kota Bogor</h2>
            </div>
        </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100 border-primary">
                    <div class="card-header bg-primary text-white text-center">
                        <h4 class="mb-0"><i class="fas fa-eye"></i> VISI</h4>
                    </div>
                    <div class="card-body">
                        ...
                        @else
                            <p class="card-text text-center fw-bold text-muted">
                                "Terwujudnya Kota Bogor yang Maju, Mandiri dan Berkeadilan dalam Pembangunan Perumahan, Permukiman dan Pertanahan"
                            </p>
                        @endif
                    </div>
                </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100 border-success">
                    <div class="card-header bg-success text-white text-center">
                        <h4 class="mb-0"><i class="fas fa-bullseye"></i> MISI</h4>
                    </div>
                    <div class="card-body">
                        ...
                        @else
                            <ol class="card-text">
                                <li>Meningkatkan kualitas dan kuantitas perumahan yang layak huni</li>
                                <li>Mengembangkan kawasan permukiman yang berkelanjutan</li>
                                <li>Mengoptimalkan pemanfaatan dan pengelolaan tanah</li>
            ...
            <div class="col-12">
                <div class="card border-info">
                    <div class="card-header bg-info text-white text-center">
                        <h4 class="mb-0"><i class="fas fa-star"></i> TUJUAN STRATEGIS</h4>
                    </div>
                    <div class="card-body">
                        @if($visiMisi && $visiMisi->tujuan_strategis)
                            <div class="card-text">
                                {!! nl2br(e($visiMisi->tujuan_strategis)) !!}
                            </div>
                        @else
                            <div class="row">
                                <div class="col-md-6">
                                    <h5 class="text-info">Tujuan 1:</h5>
                                    <p>Meningkatkan akses masyarakat terhadap perumahan yang layak huni dan terjangkau</p>
                                    
                                    <h5 class="text-info">Tujuan 2:</h5>
                                    <p>Mengembangkan kawasan permukiman yang berwawasan lingkungan dan berkelanjutan</p>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="text-info">Tujuan 3:</h5>
                                    <p>Mengoptimalkan pemanfaatan dan pengelolaan tanah untuk kepentingan publik</p>
                                    
                                    <h5 class="text-info">Tujuan 4:</h5>
                                    <p>Meningkatkan kualitas pelayanan publik dalam bidang perumahan, permukiman dan pertanahan</p>
                                </div>
                            </div>
                        @endif
                    </div>
