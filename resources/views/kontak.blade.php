...
<head>
    ...
    <title>Kontak - DISPERUMKIM Kota Bogor</title>
</head>
<body>
    <!-- Navbar -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="text-center mb-4">Kontak DISPERUMKIM Kota Bogor</h2>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0"><i class="fas fa-map-marker-alt"></i> Alamat Kantor</h5>
                    </div>
                    <div class="card-body">
                        <p class="card-text">
                            <strong>Dinas Perumahan, Permukiman dan Pertanahan Kota Bogor</strong><br>
                            Jl. Raya Pajajaran No. 25<br>
            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            <strong>Telepon:</strong> (0251) 123456<br>
                            <strong>Fax:</strong> (0251) 123457<br>
                            <strong>Email:</strong> info@disperumkim.bogor.go.id<br>
                            <strong>Website:</strong> www.disperumkim.bogor.go.id
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-header bg-info text-white">
                        <h5 class="mb-0"><i class="fas fa-clock"></i> Jam Operasional</h5>
                    </div>
                    <div class="card-body">
                        <p class="card-text">
                            <strong>Senin - Kamis:</strong> 08:00 - 16:00<br>
                            <strong>Jumat:</strong> 08:00 - 15:00<br>
                            <strong>Sabtu - Minggu:</strong> Tutup<br>
                            <strong>Hari Libur Nasional:</strong> Tutup
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-header bg-warning text-dark">
                        <h5 class="mb-0"><i class="fas fa-comments"></i> Media Sosial</h5>
                    </div>
                    <div class="card-body">
                        <p class="card-text">
                            <strong>Facebook:</strong> DISPERUMKIM Kota Bogor<br>
                            <strong>Instagram:</strong> @disperumkim_bogor<br>
                            <strong>Twitter:</strong> @disperumkim_bgr<br>
                            <strong>YouTube:</strong> DISPERUMKIM Bogor
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="card border-secondary">
                    ...
                    <div class="card-body">
                        <p class="text-center">
                            Untuk informasi lebih lanjut, silakan hubungi kami melalui kontak yang tersedia di atas.<br>
                            Tim kami siap melayani pertanyaan dan permintaan informasi dari masyarakat.
                        </p>
                    </div>
                </div>
            </div>
