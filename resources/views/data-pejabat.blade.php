...
<head>
    ...
    <title>Data Pejabat - DISPERUMKIM Kota Bogor</title>
</head>
<body>
    <!-- Navbar -->
    ...
    <!-- Data Pejabat Section -->
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="text-center mb-4">Data Pejabat DISPERUMKIM Kota Bogor</h2>
            </div>
        </div>
        
        @if($pejabats->count() > 0)
            <div class="table-responsive">
                <table class="table pejabat-table">
                    <thead>
                        <tr>
                        ...
                        @foreach($pejabats as $index => $pejabat)
                            <tr>
                                ...
                                <td class="text-center">
                                    @if($pejabat->foto)
                                        <img src="{{ asset('storage/' . $pejabat->foto) }}" alt="{{ $pejabat->nama }}" class="rounded" style="width: 80px; height: 100px; object-fit: cover;">
                                    @else
                                        <div class="bg-secondary d-flex align-items-center justify-content-center rounded" style="width: 80px; height: 100px; margin: 0 auto;">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> Belum ada data pejabat yang tersedia.
                    </div>
                </div>
            </div>
        @endif
    ...
    <style>
        ...
        .pejabat-table tbody td {
            border: 1px solid #dee2e6 !important;
            padding: 12px;
            vertical-align: middle;
        }
        
        .pejabat-table tbody tr {
        ...
        .pejabat-table tbody tr:nth-child(even):hover {
